...
namespace ConsoleApp1
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Hello\n");
            //Console.WriteLine("Enter Some Value I will print: ");

            //string g = Console.ReadLine();

            //Console.WriteLine("Enter Some charcter I will print ascii value: ");
            //int h = Console.Read();
            ...
            ConsoleProject.PrintBillingSystem();
